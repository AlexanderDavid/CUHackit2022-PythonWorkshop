...
\begin{frame}{Walrus Operator}
  \begin{example}
  \lstinputlisting[language=Python, lastline=12]{code/walrus.py}
  \end{example}
\end{frame}
...
\begin{frame}{Walrus Operator}
  \begin{example}
  \lstinputlisting[language=Python, firstline=14]{code/walrus.py}
  \end{example}
\end{frame}
...
\begin{frame}{Type Union Operator}
  ...
  \begin{example}
    \lstinputlisting[language=Python, lastline=13]{code/310.py}
  \end{example}
  \end{itemize}
\end{frame}
...
\begin{frame}{Structural Pattern Matching}
  \begin{example}
  \lstinputlisting[language=Python, lastline=15]{code/310.py}
  \end{example}
\end{frame}
